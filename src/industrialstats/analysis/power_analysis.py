...
class PowerAnalysis:
    ...
    def _calculate_power_t_test(
        self, effect_size: float, alpha: float, sample_size: int, test_type: str
    ) -> float:
    ...
    def _calculate_power_anova(
        self, effect_size: float, alpha: float, sample_size: int, n_groups: int
    ) -> float:
    ...
    def _calculate_power_factorial(
        self,
        effect_size: float,
        alpha: float,
        replicates: int,
    ...
    def _calculate_power_regression(
        self, effect_size: float, alpha: float, sample_size: int, n_predictors: int
    ) -> float:
    ...
    def _solve_for_sample_size_t_test(
        self, effect_size: float, alpha: float, power: float, test_type: str
    ) -> int:
        """Solve for sample size in t-test."""
        # Use iterative search
        for n in range(2, 10000):
            calculated_power = self._calculate_power_t_test(
                effect_size, alpha, n, test_type
            )
    ...
    def _solve_for_sample_size_anova(
        self, effect_size: float, alpha: float, power: float, n_groups: int
    ) -> int:
        """Solve for sample size in ANOVA."""
        # Use iterative search
        for n in range(2, 10000):
            calculated_power = self._calculate_power_anova(
                effect_size, alpha, n, n_groups
            )
            if calculated_power >= power:
                return n
    ...
    def _solve_for_sample_size_regression(
        self, effect_size: float, alpha: float, power: float, n_predictors: int
    ) -> int:
        """Solve for sample size in regression."""
        # Use iterative search
        for n in range(n_predictors + 2, 10000):
            calculated_power = self._calculate_power_regression(
                effect_size, alpha, n, n_predictors
            )
            if calculated_power >= power:
                return n
    ...
    def _solve_for_effect_size_t_test(
        self, alpha: float, power: float, sample_size: int, test_type: str
    ) -> float:
        ...
        while high - low > tolerance:
            mid = (low + high) / 2
            calculated_power = self._calculate_power_t_test(
                mid, alpha, sample_size, test_type
            )
    ...
    def _solve_for_effect_size_anova(
        self, alpha: float, power: float, sample_size: int, n_groups: int
    ) -> float:
        ...
        while high - low > tolerance:
            mid = (low + high) / 2
            calculated_power = self._calculate_power_anova(
                mid, alpha, sample_size, n_groups
            )
    ...
    def _solve_for_effect_size_regression(
        self, alpha: float, power: float, sample_size: int, n_predictors: int
    ) -> float:
        ...
        while high - low > tolerance:
            mid = (low + high) / 2
            calculated_power = self._calculate_power_regression(
                mid, alpha, sample_size, n_predictors
            )
